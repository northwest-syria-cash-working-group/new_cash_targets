...
*Update*: **Target option 1, or 662,924 persons, has been selected**, based on partners' current capacity to meet needs. Additionally, the population whose houses have been completely or severely damaged should be prioritised above the populations whosehouses have received major damage. 
...
For a more detailed explanation, please see this document on the [Betti-Verma formula](http://medim.ceps.lu/stata/mdepriv_v3.pdf) to understand the math behind how these variables were weighted. Though, in brief, the Betti-Vermi formula is an improved weighted average that penalises redundancy and rewards variation (i.e. extremes will tend to have higher scores).  

A **sub-district-level breakdown** of these new proposed targets may be downloaded **[here](https://github.com/northwest-syria-cash-working-group/new_cash_targets/raw/main/data/proposed_targets_preliminary_allocation.xlsx)**. Bear in mind that we have selected **Option 1**. 
